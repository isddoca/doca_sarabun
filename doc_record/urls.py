...
urlpatterns = [
    ...
    path('send/unit/<int:unit_id>', send.DocSendOutListView.as_view(), name='send_out'),
    path('send/unit/<int:unit_id>/<int:id>', send.doc_send_detail, name='send_out'),
    path('send/unit/<int:unit_id>/<int:id>/edit/', send.doc_send_edit, name='send_out'),
    path('send/unit/<int:unit_id>/<int:id>/delete/', send.doc_send_delete, name='send_out_delete'),
    path('send/unit/add', send.doc_send_add, name='send_out'),
    path('send/unit/credential', send.DocSendCredentialOutListView.as_view(), name='send_credential_out'),
    path('send/unit/credential/add', send.doc_send_add, name='send_credential_out'),
    path('send/unit/credential/<int:id>/', send.doc_send_detail, name='send_credential_out'),
    path('send/unit/credential/<int:id>/edit/', send.doc_send_edit, name='send_credential_out'),
    path('send/unit/credential/<int:id>/delete/', send.doc_send_delete, name='send_out_credential_delete'),
