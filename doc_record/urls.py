...
urlpatterns = [
    ...
    path('send/out/<int:id>/delete/', send.doc_send_delete, name='send_out_delete'),
    ...
    path('send/out/credential/<int:id>/delete/', send.doc_send_delete, name='send_out_credential_delete'),
